...
std::unordered_map<AppConfig::Item, AppConfig::Option> AppConfig::settingMap = {
    ...
    {DOWNLOAD_QUALITY, {"download_quality", {"Max", "8 Mb/s", "4 Mb/s", "2 Mb/s", "1 Mb/s", "500 Kb/s", "250 Kb/s"}, {0, 1, 2, 3, 4, 5, 6}}},
    {DOWNLOAD_SMART_COUNT, {"download_smart_count", {"Off", "1", "3", "5", "10"}, {0, 1, 3, 5, 10}}},
